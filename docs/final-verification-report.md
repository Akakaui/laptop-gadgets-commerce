...
| Area | Delivered |
|---|---|
| Storefront | Sticky navigation, configurable business branding, search, category browse, product detail, SKU/specs, condition, colours, sizes, weight, options, reviews, email capture, stock messaging, cart, coupon, city selection, payment method selection, and order confirmation |
